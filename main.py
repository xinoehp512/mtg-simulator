...
game.add_cards(player1, [cards.evolving_wilds.copy(), cards.elfsworn_giant.copy(), cards.eaten_alive.copy()])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.treasure.copy() for i in range(6)]+[cards.burglar_rat.copy()])
