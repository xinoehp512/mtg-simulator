...
game.add_cards(player1, [cards.marauding_blight_priest.copy(), cards.jungle_hollow.copy()])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.treasure.copy() for i in range(6)]+[cards.dazzling_angel.copy()])
