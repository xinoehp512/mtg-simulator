...
player1 = game.players[0]
player2 = game.players[1]
game.add_cards(player1, [cards.burst_lightning.copy()])
game.add_cards(player2, [cards.forest.copy()])
game.add_permanents(player1, [cards.mountain.copy() for i in range(5)])
game.add_permanents(player2, [cards.ambush_wolf.copy(), cards.apothecary_stomper.copy()])
