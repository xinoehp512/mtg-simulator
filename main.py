...
game.add_cards(player1, [cards.hare_apparent.copy() for i in range(3)])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.treasure.copy() for i in range(6)]+[cards.gnarlid_colony.copy()])
game.add_permanents(player2, [cards.campus_guide])
