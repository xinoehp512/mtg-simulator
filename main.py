...
game.add_cards(player1, [cards.elementalist_adept.copy(), cards.bake_into_a_pie.copy()])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.dismal_backwater.copy() for i in range(6)])
