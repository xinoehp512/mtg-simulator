...
game.add_cards(player1, [cards.dwynens_elite.copy() for i in range(5)])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.forest.copy() for i in range(6)]+[cards.dazzling_angel.copy()])
