...
game.add_cards(player1, [cards.gleaming_barrier.copy()])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.treasure.copy() for i in range(6)]+[cards.apothecary_stomper.copy(), cards.gleaming_barrier.copy()])
game.add_permanents(player2, [cards.gleaming_barrier.copy()])
