...
game.add_cards(player1, [cards.gnarlid_colony.copy(), cards.fleeting_flight.copy()])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.treasure.copy() for i in range(6)]+[cards.axgard_cavalry.copy()])
game.add_permanents(player2, [cards.campus_guide.copy()])
