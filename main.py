...
game.add_cards(player1, [cards.banishing_light.copy(), cards.campus_guide.copy(), cards.bite_down.copy()])
game.add_cards(player2, [cards.forest.copy() for i in range(1)])
game.add_permanents(player1, [cards.blossoming_sands.copy() for i in range(7)]+[cards.crackling_cyclops.copy()])
