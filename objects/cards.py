...
human = Creature_Card("Human (W)", "W", [CardType.CREATURE], [], 1, 1)
merfolk = Creature_Card("Merfolk (U)", "U", [CardType.CREATURE], [], 1, 1)
goblin = Creature_Card("Goblin (R)", "R",  [CardType.CREATURE], [], 1, 1)
druid = Creature_Card("Druid (G)", "G",  [CardType.CREATURE], [], 1, 1)

ox = Creature_Card("Ox (1W)", "1W", [CardType.CREATURE], [], 2, 2)
crab = Creature_Card("Crab (1U)", "1U", [CardType.CREATURE], [], 1, 3)
dwarf = Creature_Card("Dwarf (1R)", "1R", [CardType.CREATURE], [], 3, 1)
bear = Creature_Card("Bear (1G)", "1G", [CardType.CREATURE], [], 2, 2)

horse = Creature_Card("Horse (2W)", "2W", [CardType.CREATURE], [], 3, 3)
serpent = Creature_Card("Serpent (2U)", "2U", [CardType.CREATURE], [], 2, 5)
drake = Creature_Card("Drake (2R)", "2R", [CardType.CREATURE], [], 4, 2)
ent = Creature_Card("Ent (2G)", "2G", [CardType.CREATURE], [], 3, 3)

angel = Creature_Card("Angel (3W)", "3W", [CardType.CREATURE], [], 4, 4)
sphinx = Creature_Card("Sphinx (3U)", "3U", [CardType.CREATURE], [], 3, 6)
dragon = Creature_Card("Dragon (3R)", "3R", [CardType.CREATURE], [], 7, 1)
dinosaur = Creature_Card("Dinosaur (3G)", "3G", [CardType.CREATURE], [], 5, 5)
...
destroy = Sorcery_Card("Destroy (1)", "1", [CardType.SORCERY], [destroy_ability])
draw = Instant_Card("Draw (1)", "1", [CardType.INSTANT], [draw_card_ability])


aegis_turtle = Creature_Card("Aegis Turtle (U)", "U", [CardType.CREATURE, CreatureType.TURTLE], [], 0, 5)
ambush_wolf = Creature_Card("Ambush Wolf (2G)", "2G", [CardType.CREATURE, CreatureType.WOLF], [flash, ambush_wolf_etb], 4, 2)
apothecary_stomper = Creature_Card("Apothecary Stomper (4GG)", "4GG", [CardType.CREATURE, CreatureType.ELEPHANT], [
                                   vigilance, apothecary_stomper_etb], 4, 4)
armasaur_guide = Creature_Card("Armasaur Guide (4W)", "4W", [CardType.CREATURE, CreatureType.DINOSAUR], [
                               vigilance, armasaur_guide_attack], 4, 4)
axgard_cavalry = Creature_Card("Axgard Cavalry (1R)", "1R", [CardType.CREATURE,
                               CreatureType.DWARF, CreatureType.BERSERKER], [axgard_cavalry_tap], 2, 2)
bake_into_a_pie = Instant_Card("Bake into a Pie (2BB)", "2BB", [CardType.INSTANT], [bake_into_a_pie_ability])
banishing_light = Enchantment_Card("Banishing Light (2W)", "2W", [CardType.ENCHANTMENT], [banishing_light_ability])
beast_kin_ranger = Creature_Card("Beast-Kin Ranger (2G)", "2G",
                                 [CardType.CREATURE, CreatureType.ELF, CreatureType.RANGER], [trample, beastkin_ranger_pump], 3, 3)
bigfin_bouncer = Creature_Card("Bigfin Bouncer (3U)", "3U", [CardType.CREATURE,
                               CreatureType.SHARK, CreatureType.PIRATE], [bigfin_bouncer_etb], 3, 2)
bite_down = Instant_Card("Bite Down (1G)", "1G", [CardType.INSTANT], [bite_down_ability])
...
broken_wings = Instant_Card("Broken Wings (2G)", "2G", [CardType.INSTANT], [broken_wings_ability])
burglar_rat = Creature_Card("Burglar Rat (1B)", "1B", [CardType.CREATURE, CreatureType.RAT], [burglar_etb], 1, 1)
...
courageous_goblin = Creature_Card("Courageous Goblin (1R)", "1R", [
                                  CardType.CREATURE, CreatureType.GOBLIN], [courageous_goblin_attack], 2, 2)
crackling_cyclops = Creature_Card("Crackling Cyclops (2R)", "2R", [
                                  CardType.CREATURE, CreatureType.CYCLOPS, CreatureType.WIZARD], [crackling_cyclops_pump], 0, 4)
crypt_feaster = Creature_Card("Crypt Feaster (3B)", "3B", [CardType.CREATURE, CreatureType.ZOMBIE], [menace, crypt_feaster_threshold], 3, 4)
dazzling_angel = Creature_Card("Dazzling Angel (2W)", "2W", [CardType.CREATURE, CreatureType.ANGEL], [flying, dazzling_angel_gain], 2, 3)
dismal_backwater = Land_Card("Dismal Backwater", [CardType.LAND], [enters_tapped_replacement, gain_1_etb, dimir_land_ability])
dwynens_elite = Creature_Card("Dwynen's Elite (1G)", "1G", [CardType.CREATURE,
                              CreatureType.ELF, CreatureType.WARRIOR], [dwynens_elite_etb], 2, 2)
eaten_alive = Sorcery_Card("Eaten Alive (B)", "B", [CardType.SORCERY], [eaten_alive_ability, eaten_alive_extra_cost])
elementalist_adept = Creature_Card("Elementalist Adept (1U)", "1U", [
                                   CardType.CREATURE, CreatureType.HUMAN, CreatureType.WIZARD], [flash, prowess], 2, 1)
elfsworn_giant = Creature_Card("Elfsworn Giant (3GG)", "3GG", [CardType.CREATURE, CreatureType.GIANT], [
                               reach, elfsworn_giant_landfall], 5, 3)
erudite_wizard = Creature_Card("Erudite Wizard (2U)", "2U", [CardType.CREATURE,
...
fake_your_own_death = Instant_Card("Fake Your Own Death (1B)", "1B", [CardType.INSTANT], [fake_your_own_death_ability])
fanatical_firebrand = Creature_Card("Fanatical Firebrand (R)", "R", [CardType.CREATURE, CreatureType.GOBLIN, CreatureType.PIRATE], [
                                    haste, fanatical_firebrand_sac], 1, 1)
felidar_savior = Creature_Card("Felidar Savior (3W)", "3W", [CardType.CREATURE,
                               CreatureType.CAT, CreatureType.BEAST], [lifelink, felidar_savior_etb], 2, 3)
firebrand_archer = Creature_Card("Firebrand Archer (1R)", "1R", [
                                 CardType.CREATURE, CreatureType.HUMAN, CreatureType.ARCHER], [firebrand_archer_ping], 2, 1)
fleeting_distraction = Instant_Card("Fleeting Distraction (U)", "U", [CardType.INSTANT], [fleeting_distraction_ability])
fleeting_flight = Instant_Card("Fleeting Flight (W)", "W", [CardType.INSTANT], [fleeting_flight_ability])
giant_growth = Instant_Card("Giant Growth (G)", "G", [CardType.INSTANT], [giant_growth_ability])
gleaming_barrier = Creature_Card("Gleaming Barrier (2)", "2", [CardType.ARTIFACT, CardType.CREATURE, CreatureType.WALL], [
