...
dwynens_elite = Creature_Card("Dwynen's Elite (1G)", [ManaCost.GENERIC]+[ManaCost.GREEN],
                              [CardType.CREATURE, CreatureType.ELF, CreatureType.WARRIOR], [dwynens_elite_etb], "", 2, 2)
