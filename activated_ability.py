class Activated_Ability:
    def __init__(self, name, cost, result_function, mode_choice, is_mana_ability=False, mana_produced=None) -> None:
        self.name = name
        self.cost = cost
    ...
    def copy(self):
        return Activated_Ability(self.name, self.cost.copy(), self.result_function, self.mode_choice, is_mana_ability=self.is_mana_ability, mana_produced=self.mana_produced)
